    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid33", tween: [ "style", "${_Final-Figure2}", "display", 'block', { fromValue: 'none'}], position: 53[500, "%"], duration: 0 },
                ...
                { id: "eid22", tween: [ "transform", "${_Packet-1}", "rotateZ", '93deg', { fromValue: '93deg'}], position: 34[94, "%"], duration: 1585 },
                ...
                { id: "eid30", tween: [ "style", "${_Text4}", "display", 'block', { fromValue: 'none'}], position: 33[94, "%"], duration: 0 },
                ...
                { id: "eid9", tween: [ "motion", "${_Packet-1}", [[196, 82.5, 0, 0],[213.5, 99.94, 41.[94, "%"], 4.44, 39.02, 4.21],[272.77, 90.79, 82.02, 8.85, 68.2, 7.36],[360.23, 138.18, 117.41, 12.67, 94.43, 10.19],[473.03, 142.69, 87.35, -18.85, 88.44, -19.09],[529.6, 119.[75, "%"], 0, 0]]], position: 1000, duration: 2000 },
                { id: "eid21", tween: [ "motion", "${_Packet-1}", [[529.6, 121.13, 0, 0],[563.66, 119.67, 32.84, -2.93, 12.73, -1.13],[575.22, 118.01, 77.78, 4.63, 46.9, 2.79],[615.27, 126.5, 0, 0]]], position: 34[94, "%"], duration: 1585 },
                ...
                { id: "eid16", tween: [ "motion", "${_Packet-3}", [[1[375, "%"], 70.5, 0, 0],[216.9, 98.[475, "%"], 48.97, 10.39, 83.[338, "%"], 17.72],[274.77, 91.26, 100.34, 16.[94, "%"], 60.25, 9.7],[360.98, 135.2, 129.74, 31.61, 91.56, 22.31],[450.4, 139.3, 0, 0]]], position: 1500, duration: 1500 },
