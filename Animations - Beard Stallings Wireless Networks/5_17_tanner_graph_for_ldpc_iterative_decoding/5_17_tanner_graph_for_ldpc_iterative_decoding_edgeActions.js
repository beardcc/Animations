...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3115, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3885, function(sym, e) {
         // insert code here
         sym.stop();
