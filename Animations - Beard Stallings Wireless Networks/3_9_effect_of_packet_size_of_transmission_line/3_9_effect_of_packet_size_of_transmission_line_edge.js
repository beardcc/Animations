...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "Node a now has the full packet. It can start sending the packet at time <i>t<sub>1</sub></i>.",
                align: "center",
                font: ['Times New Roman, Times, serif', [94, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
                ...
                text: "Node b receives the packet. After it has received the entire packet, Node b starts sending the packet to Node Y at <i>t<sub>2</sub></i>.",
                align: "center",
                font: ['Times New Roman, Times, serif', [94, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid166", tween: [ "style", "${_Text3}", "width", '97px', { fromValue: '97px'}], position: 600, duration: 0 },
                ...
                { id: "eid6", tween: [ "style", "${_Data_1}", "top", '255px', { fromValue: '61px'}], position: 600, duration: 1500 },
                ...
                { id: "eid11", tween: [ "style", "${_Text3}", "display", 'block', { fromValue: 'none'}], position: 600, duration: 0 },
