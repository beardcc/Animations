...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "With frequencies f, 3f and 5f.",
                align: "left",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['144px', '913px','500px','60px','auto', 'auto'],
                text: "Fgure 2.5 Frequency Components of Square Wave (T = 1/f )",
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['208px', '249px','466px','17px','auto', 'auto'],
                text: "(a) (4/π) [sin (2πft) + (1/3) sin (2π(3f)t) + (1/5) sin (2π(5f)t)]",
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['161px', '564px','511px','24px','auto', 'auto'],
                text: "( b) (4/π) [sin (2πft) + (1/3) sin (2π(3f)t) + (1/5) sin (2π(5f)t) + (1/7) sin (2π(7f)t)]",
                align: "left",
                font: ['Times New Roman, Times, serif', 12, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['274px', '849px','263px','24px','auto', 'auto'],
                text: "(c) (4/π) Â (1/k) sin (2π(kf)t),     for k odd",
                align: "left",
                font: ['Times New Roman, Times, serif', 12, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
            ...
            },
            {
                ...
                text: "Now also with frequencies 7f.",
                align: "left",
                font: ['Times New Roman, Times, serif', 12, "rgba(0,0,0,1)", "bold", "none", "normal"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid61", tween: [ "style", "${_Text9}", "font-size", '15px', { fromValue: '15px'}], position: 8500, duration: 0 },
                ...
                { id: "eid63", tween: [ "style", "${_Text8}", "font-size", '15px', { fromValue: '15px'}], position: 4333, duration: 0 },
                ...
                { id: "eid60", tween: [ "style", "${_Text10}", "font-size", '15px', { fromValue: '15px'}], position: 12903, duration: 0 },
                ...
                { id: "eid36", tween: [ "style", "${__2}", "top", '322px', { fromValue: '-322px'}], position: 6500, duration: 1500 },
                ...
                { id: "eid27", tween: [ "style", "${__1}", "top", '44px', { fromValue: '-180px'}], position: 2000, duration: 1500 },
