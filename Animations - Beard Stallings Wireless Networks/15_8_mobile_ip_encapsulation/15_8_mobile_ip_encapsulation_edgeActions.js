...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3140, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 5625, function(sym, e) {
         // insert code here
         sym.stop();
