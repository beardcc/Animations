...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                font: ['Times New Roman, Times, serif', [1[119, "%"], "%"], "rgba(0,0,0,1)", "700", "none", ""]
            },
            {
                id: 'Text2',
                display: 'block',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid33", tween: [ "style", "${_SWP}", "display", 'block', { fromValue: 'none'}], position: 24[375, "%"], duration: 0 },
                ...
                { id: "eid140", tween: [ "style", "${_Text12}", "display", 'block', { fromValue: 'none'}], position: 104[375, "%"], duration: 0 },
                ...
                { id: "eid31", tween: [ "style", "${_Text3}", "display", 'none', { fromValue: 'block'}], position: 24[375, "%"], duration: 0 },
