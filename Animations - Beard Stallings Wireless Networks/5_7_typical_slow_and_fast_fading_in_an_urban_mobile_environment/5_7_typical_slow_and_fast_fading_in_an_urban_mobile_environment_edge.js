...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "Figure 5.7 Typical Slow and Fast Fading in an Urban Mobile  Environment",
            ...
            },
            {
                ...
                text: "This is the actual signal strength. Multipath causes severe signal strength variations from the average over small distances.   ",
                align: "center",
                font: ['\'Times New Roman\', Times, serif', [94, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid16", tween: [ "style", "${_Text4}", "left", '78px', { fromValue: '78px'}], position: 1811, duration: 0 },
                { id: "eid17", tween: [ "style", "${_Text4}", "width", '500px', { fromValue: '500px'}], position: 1811, duration: 0 },
