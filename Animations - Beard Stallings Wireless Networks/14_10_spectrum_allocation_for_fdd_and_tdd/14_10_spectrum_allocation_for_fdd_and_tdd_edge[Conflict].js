...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'Text',
                type: 'text',
                rect: ['383px', '1870px','auto','auto','auto', 'auto'],
                text: "Figure  14.10  Spectrum Allocation for FDD and TDD",
                font: ['Times New Roman, Times, serif', 80, "rgba(0,0,0,1)", "700", "none", ""]
            },
            {
                id: 'Text2',
                display: 'block',
                ...
                align: "left",
                font: ['\'Times New Roman\', Times, serif', 60, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
                id: 'fdd',
                display: 'none',
            ...
            },
            {
                ...
                text: "User 1 uses subcarrier blocks<br>U1 for upload and D1 for download,<br>separated by Wo.",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', 60, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['660px', '1004px','1072px','456px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"channel-234.png",'0px','0px']
            },
            {
                id: 'Text5',
                display: 'none',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid60", tween: [ "style", "${_channel-234}", "width", '1072px', { fromValue: '6px'}], position: 13500, duration: 1250 },
