...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'Text',
                type: 'text',
                rect: ['69px', '477px','544px','auto','auto', 'auto'],
                text: "Figure 6.11 Sketch of Three Important Propagation Mechanisms:<br>Reflection(R), Scattering(S), Diffraction(D) [ANDE95]",
                align: "center",
