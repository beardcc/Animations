...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text2',
                type: 'text',
                rect: ['268px', '396px','193px','38px','auto', 'auto'],
                text: "(a) Frequency Division Multiplexing",
                align: "left",
                font: ['Times New Roman, Times, serif', 12, "rgba(0,0,0,1)", "700", "none", "normal"]
            },
            {
                id: 'Text3',
                type: 'text',
                rect: ['288px', '835px','184px','27px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'text',
                rect: ['180px', '900px','416px','27px','auto', 'auto'],
