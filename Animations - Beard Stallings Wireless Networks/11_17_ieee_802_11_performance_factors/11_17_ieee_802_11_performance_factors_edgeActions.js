...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 2560, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4566, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4657, function(sym, e) {
         // insert code here
         sym.stop();
