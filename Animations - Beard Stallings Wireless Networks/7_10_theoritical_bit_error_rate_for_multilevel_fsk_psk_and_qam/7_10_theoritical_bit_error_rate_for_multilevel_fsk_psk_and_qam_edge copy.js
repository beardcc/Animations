...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text7',
                type: 'text',
                rect: ['132px', '570px','auto','auto','auto', 'auto'],
            ...
            },
            {
                ...
                text: "2 and 4 level PSK ( BPSK and QPSK )<br> provide same performance.",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', 15, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
                ...
                text: "8 PSK increases data rate but also uses<br>more energy for the same BER.",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', 15, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
                ...
                text: "16 QAM increases bit rate even more <br>at not much worse performance than <br>8 PSK. ",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', 15, "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid98", tween: [ "style", "${_Text2}", "width", '264px', { fromValue: '264px'}], position: 3305, duration: 0 },
