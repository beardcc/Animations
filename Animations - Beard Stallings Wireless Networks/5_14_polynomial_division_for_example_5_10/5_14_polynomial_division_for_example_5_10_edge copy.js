...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "Figure 5.14 Polynomial Division for Example 5.10",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid29", tween: [ "style", "${_Text2}", "display", 'none', { fromValue: 'block'}], position: 3080, duration: 0 },
                ...
                { id: "eid30", tween: [ "style", "${_Text6}", "display", 'none', { fromValue: 'block'}], position: 3080, duration: 0 },
                ...
                { id: "eid32", tween: [ "style", "${_Text4}", "display", 'none', { fromValue: 'block'}], position: 3080, duration: 0 },
                ...
                { id: "eid33", tween: [ "style", "${_Text5}", "display", 'none', { fromValue: 'block'}], position: 3080, duration: 0 },
                ...
                { id: "eid31", tween: [ "style", "${_Text3}", "display", 'none', { fromValue: 'block'}], position: 3080, duration: 0 },
