...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "Node B indicates<br>it is Ready to Receive (RR) PDU 2.",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', [375, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['1367px', '1404px','650px','364px','auto', 'auto'],
            ...
            },
            {
                ...
                text: "RR0 is sent but not received in Timeout waititng time.",
                align: "left",
                font: ['\'Times New Roman\', Times, serif', [375, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
            ...
            },
            {
                id: 'Text2',
                type: 'text',
                rect: ['476px', '2788px','1038px','76px','auto', 'auto'],
                text: "Figure 10.20 Go-back-N ARQ",
                align: "left",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid73", tween: [ "style", "${_Text}", "left", '287px', { fromValue: '287px'}], position: 24145, duration: 0 },
