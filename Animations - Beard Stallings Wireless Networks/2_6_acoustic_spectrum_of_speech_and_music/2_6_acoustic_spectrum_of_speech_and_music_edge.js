...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                text: "25 dB range of signal power for voice",
                align: "center",
                font: ['Times New Roman, Times, serif', [75, "%"], "rgba(0,0,0,1)", "bold", "none", "normal"]
            },
            {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid60", tween: [ "style", "${_Text14}", "font-size", '94%', { fromValue: '15px'}], position: 2500, duration: 0 },
                ...
                { id: "eid54", tween: [ "style", "${_Text11}", "font-size", '94%', { fromValue: '15px'}], position: 500, duration: 0 },
                ...
                { id: "eid82", tween: [ "style", "${_Text12}", "top", '63px', { fromValue: '63px'}], position: 1180, duration: 0 },
                ...
                { id: "eid65", tween: [ "style", "${_Text15}", "font-size", '94%', { fromValue: '15px'}], position: 3250, duration: 0 },
                { id: "eid70", tween: [ "style", "${_Text6}", "font-size", '75%', { fromValue: '12px'}], position: 3500, duration: 0 },
                { id: "eid57", tween: [ "style", "${_Text13}", "font-size", '94%', { fromValue: '15px'}], position: 1750, duration: 0 },
                { id: "eid56", tween: [ "style", "${_Text12}", "font-size", '94%', { fromValue: '15px'}], position: 1100, duration: 0 },
